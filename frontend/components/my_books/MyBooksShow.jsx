...
export default class MyBooksShow extends React.Component {
  ...
  initPenNames() {
    if (this.props.isNew) {
      return this.defaultPenNameId() ? [{id: this.defaultPenNameId(), author_name: 'Loading...'}] : []
    } else if (this.props.book) {
  ...
  populateWithAmazonProductsApi(bookLinkUrl) {
    AmazonProductsApi.getItemAttrs(bookLinkUrl).then(attrs => {
      ...
      ['amazon_author', 'review_count', 'avg_review', 'pub_date', 'book_rank'].forEach(attr => {
        if (attrs[attr]) {
  ...
  populateWithGoogleBooksApi(bookLinkUrl) {
    GooglePlayBooksApi.getItemAttrs(bookLinkUrl).then(attrs => {
      ...
      if (attrs.volumeInfo.imageLinks && attrs.volumeInfo.imageLinks.thumbnail && !book.cover_image_url) {
  ...
  _update() {
    this.setState({bookCurrentlySaving: true}, function() {
      ...
      MyBooksApi.update(data).then(res => {
    ...
    if (this.props.isMobile) {
      return (
        <input
          ...
          placeholderText={this.state.book.launch_date ? '' : "Select a date"}
      ...
      return (
        <div>
          <DatePicker
            selected={this.state.book.launch_date_moment || ''}
            dateFormat="MMMM D, YYYY"
            placeholderText={this.state.book.launch_date_moment ? '' : "Select a date"}
            onChange={this.datePickerChangeHandler.bind(this)} />
          <input type="hidden" name="book[launch_date]" value={this.state.book.launch_date || ''} />
        </div>
      )
    }
  }
          ...
          <div className="my-books-show-content">
            ...
            <div className="my-books-show-form-container">
              <form method="POST" action={this.formActionPath()}>
                ...
                <input type='hidden' name='cal_back' value={queryString.parse(location.search).cal_back} />
                ...
                <div className="my-books-fields-container">
                  ...
                  <div className="my-books-input">
                    ...
                    <Select 
                        ...
                        placeholder={this.state.book.pen_name_id ? "" : "Select Pen Name"} />
                  </div>
                  ...
                  <div className="my-books-input" style={{paddingBottom: '0px'}}>
                  ...
                  <div className="my-books-input half" style={{paddingBottom: '0px'}}>
                  ...
                  <div className="my-books-input half" style={{paddingBottom: '0px'}}>
                    ...
                    <input 
                        type="text" 
                        disabled={true}
                        value={this.state.book.pub_date ? moment(this.state.book.pub_date, "YYYY-MM-DD").format("MMM DD, YYYY") : ''}
                        required
                        onChange={() => {}}
                        placeholder={"Data not available"} />
                  </div>
                  ...
                  <div className="my-books-images">
                    <div className="my-books-images-uploading">
                      <div className="fileuploader">
                        <label htmlFor="fileupload" className="btn bclick-button bclick-hollow-green-button not-phone">
                          Upload Cover Image
                        </label>
                        
                        <label htmlFor="fileupload" className="btn bclick-button bclick-hollow-green-button phone">
                          Add Image
                        </label>
                        <input 
                          id="fileupload" 
                      ...
                      <div 
                        ...
                        style={{display: this.state.book.cover_image_url ? "block" : "none"}}
                    ...
                    <div 
                      ...
                      style={{"border": (this.state.book.cover_image_url ? "none" : "1px solid #e9e9e9")}}>
                      <div className="my-books-images-img-placeholder" style={{textShadow: 'none'}}>
                        Cover Image
                      </div>
                  ...
                  <div className={"my-books-show-submit" + (this.props.isLaunchPage ? " hide" : "")}>
